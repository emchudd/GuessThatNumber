...
let randomNum;
//For storing user's remaining attempts
let attempts;
//For storing user's guess
let guess;
...
while (restartGame){
    ...
    //Verifies the user's entryfor a range number is a number greater than zero (NOTE: All numbers, positive and negative, have a default boolean value of true, except for zero, which has a boolean value of false. NAN has a default boolean value of false as well.)
    ...
    //Prompts user to enter a number of attempts allowed (AKA Number if guesses)
    ...
    while (true){
        ...
        if (playAgain.toUppercase() === "N"){
            ...
            //The game restarts
            break;
            //Prompts user to enter a valid response and start the loop again
        } else {
